...
#CREATE
	...
	url(r'player/player_create/$'   ,Create.as_view(model = Player, form_class = PlayerForm, template_name = 'forms.html'), name = 'PlayersCreate'),
...
#EDIT
	...
	url(r'player/(?P<pk>\d+)/player_edit/$'   ,Edit.as_view(model = Player, form_class = PlayerForm, template_name = 'forms.html')),
